...
namespace DI_Service_LifeTime.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(ScopedGuidService scoped1,
        ...
        public IActionResult Index()
        {
            ...
            messages.Append($"Transient 2 : {_transient1.GetGuid()}\n\n\n");

            messages.Append($"Scoped 1 : {_scoped1.GetGuid()}\n");
            messages.Append($"Scoped 2 : {_scoped2.GetGuid()}\n\n\n");

            messages.Append($"Transient 1 : {_singleton1.GetGuid()}\n");
            messages.Append($"Transient 2 : {_singleton2.GetGuid()}\n\n\n");
